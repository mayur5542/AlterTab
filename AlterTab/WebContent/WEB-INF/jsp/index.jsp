    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="slider-active">
                <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="assets/img/hero/logo2.jpg">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-11">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInUp" data-delay=".5s">AlterTab</h1>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            <div class="service-img">
                                <img src="assets/img/service/image_webDevelopment.jpeg" alt="" style="width: 370px;height: 270px;">
                            </div>
                            <div class="service-cap">
                                <h4 style="margin-bottom: 5px;"><a href="services_details.html">Web Application Development</a></h4><br><h5>xfadfgdfhfgfjdfghryhfg</h5>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            ...
                            <div class="service-cap">
                                <h4 style="margin-bottom: 5px;"><a href="services_details.html">Mobile Application Development</a></h4><br><h5>xfadfgdfhfgfjdfghryhfg</h5>
                                <!-- <a href="services_details.html" class="more-btn">Read More <i class="ti-plus"></i></a> -->
                            </div>
                            <div class="service-icon">
                                <img src="assets/img/icon/services_icon1.png" alt="">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-service-cap mb-30">
                            ...
                            <div class="service-cap">
                                <h4 style="margin-bottom: 5px;"><a href="services_details.htmlaa">Digital Marketing &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></h4><br><h5>xfadfgdfhfgfjdfghryhfg</h5>
                                <!-- <a href="services_details.html" class="more-btn">Read More <i class="ti-plus"></i></a> -->
                            </div>
                            <div class="service-icon">
                                <img src="assets/img/icon/services_icon1.png" alt="">
